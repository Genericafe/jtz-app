...
export const plansApi = {
  ...
  unassignRunner: (id: number, runnerId: number) => api.delete(`/plans/${id}/assign/runner/${runnerId}`),
  unassignGroup: (id: number, groupId: number) => api.delete(`/plans/${id}/assign/group/${groupId}`),
