...
function CoachChat() {
  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] bg-surface-800 rounded-2xl overflow-hidden border border-white/[0.06]">
      {/* Sidebar: runner list */}
      <div className="w-72 border-r border-white/[0.06] flex flex-col bg-surface-700 flex-shrink-0">
        <div className="px-4 py-4 border-b border-white/[0.06]">
          ...
          <p className="text-xs text-gray-500 mt-0.5">Coach ↔ corredor</p>
        </div>
...
function RunnerChat() {
  ...
  return (
    <div className="h-[calc(100vh-4rem)] bg-surface-800 rounded-2xl overflow-hidden border border-white/[0.06]">
      <ConversationPanel
